...
return (
    <Carousel className={`vh-100 ${HeaderCSS.header}`}>
        ...
        <div>
            <h2 className={`${HeaderCSS.header2} text-capitalize text-white`}>best collection</h2>
        ...
        <Carousel.Item className = {`text-center ${HeaderCSS.carouselItem}`}>
            <h2 className = {`${HeaderCSS.header2} text-capitalize text-white`}>best prices & offers</h2>
